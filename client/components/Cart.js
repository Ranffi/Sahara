                    ...
                    <div className="cart-content">
                        {
                            cartItems.map(item => {
                                ...
                                <div className="cart-item" key={item.id}>
                                    ...
                                    <div>
                                        <i className="fas fa-chevron-up" data-id={item.id} onClick={() => this.increasePrice(item.book.price)} />
                                        <p className="item-amount">{quantity[item.id]}</p>
                                        <i className="fas fa-chevron-down" data-id={item.id} onClick={() => this.decreasePrice(item.book.price)} />
                                    </div>`
                                </div>
                                )
                            })
